...
class XoopsConfirm
{
    ...
    public function getFormXoopsConfirm()
    {
        ...
        if (!defined('CO_CPSLIDERS_DELETE_CONFIRM')) {
            \define('CO_CPSLIDERS_DELETE_CONFIRM', 'Confirm delete');
            \define('CO_CPSLIDERS_DELETE_LABEL', 'Do you really want to delete:');
        }
        ...
        if ('' === $this->title) {
            $this->title = CO_CPSLIDERS_DELETE_CONFIRM;
        }
        if ('' === $this->label) {

            $this->label = CO_CPSLIDERS_DELETE_LABEL;
        }
