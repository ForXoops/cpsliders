 ...
 * @return bool|null
 */
function xoops_module_update_cpsliders($module, $prev_version = null)
{
    $ret = null;
    if ($prev_version < 10) {
        $ret = update_cpsliders_v10($module);
    }
 ...
 * @return bool
 */
function update_cpsliders_v10($module)
{
    global $xoopsDB;
 ...
 * @return bool
 */
function cpsliders_check_db($module)
{
    $ret = true;
    ...
    $table   = $GLOBALS['xoopsDB']->prefix('cpsliders_images');
    $field   = 'img_exif';
