...
<{if $sliders_count|default:0 != 0}>
    <table class="outer tablesorter">
        <tr>
            ...
            <th><{$smarty.const._AM_CPSLIDERS_SLIDERS_ACTION}></th>
        </tr>
            ...
            <tr class="<{cycle values='odd, even'}>">
                ...
                <td class="xo-actions txtcenter">
                    <a href="sliders.php?op=edit&amp;slider_id=<{$slider.slider_id}>" title="<{$smarty.const._EDIT}>">
                        <img src="<{xoAdminIcons edit.png}>" alt="<{$smarty.const._EDIT}>" title="<{$smarty.const._EDIT}>"/>
                    </a>
                    &nbsp;
                    <a href="sliders.php?op=delete&amp;slider_id=<{$slider.slider_id}>" title="<{$smarty.const._DELETE}>">
                        <img src="<{xoAdminIcons delete.png}>" alt="<{$smarty.const._DELETE}>" title="<{$smarty.const._DELETE}>"
                    </a>
                </td>
            </tr>
        <{/foreach}>
